...
const similarTools = [
    { nome: "Intercom", descricao: "Plataforma de atendimento ao cliente com IA para suporte automatizado.", url: "/ferramentas/intercom" },
    { nome: "Poly.ai", descricao: "Assistente de voz com IA para atendimento ao cliente por telefone 24h.", url: "/ferramentas/poly-ai" },
