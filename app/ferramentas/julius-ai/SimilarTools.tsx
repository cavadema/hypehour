...
const similarTools = [
    ...
    { nome: "Grafana", descricao: "Plataforma de observabilidade e visualização de dados com dashboards em tempo real.", url: "/ferramentas/grafana" },
    { nome: "Gamma", descricao: "Cria apresentações, documentos e páginas web com IA a partir de texto simples.", url: "/ferramentas/gamma" },
];
