...
export default function ScraperAPIPage() {
  const schemaData = {
    ...
    "@graph": [
      ...
      {
        "@type": "WebPage",
        "@id": "https://www.hypehour.com.br/ferramentas/scraperapi#webpage",
        "url": "https://www.hypehour.com.br/ferramentas/scraperapi",
        "name": "ScraperAPI - API de Proxy e Bypass de Bloqueios",
        "description": "Conheça o ScraperAPI: a solução definitiva para gerenciar proxies, rotacionar IPs e burlar CAPTCHAs em escala com uma simples chamada de API.",
        "isPartOf": { "@id": "https://www.hypehour.com.br/#website" },
        "breadcrumb": { "@id": "https://www.hypehour.com.br/ferramentas/scraperapi#breadcrumb" },
        "datePublished": "2025-11-19",
        "dateModified": "2026-07-04",
        "inLanguage": "pt-BR",
        "mainEntity": { "@id": "https://www.hypehour.com.br/ferramentas/scraperapi#software" },
      },
      ...
      },
      {
        ...
        "mainEntityOfPage": { "@id": "https://www.hypehour.com.br/ferramentas/scraperapi#webpage" },
        "image": "https://www.hypehour.com.br/logo.png",
        "featureList": ["Configure o Endpoint","Orquestração de Proxy","Renderização Opcional","Retorno do HTML","Automatic Retries","Unlimited Bandwidth"],
