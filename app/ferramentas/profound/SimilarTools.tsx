...
const similarTools = [
    {
        nome: "First Answer",
        descricao: "Monitoramento de autoridade e visibilidade para dominar a primeira resposta na IA.",
        url: "/ferramentas/first-answer"
    },
    {
        nome: "Temso",
        descricao: "Inteligência de AEO e GEO focada em benchmarking e performance de marca.",
        url: "/ferramentas/temso"
    },
    {
        nome: "Writesonic",
        descricao: "Referência em criação de conteúdo SEO com automação de visibilidade multimodelo.",
