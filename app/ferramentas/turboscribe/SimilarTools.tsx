...
const similarTools = [
    { nome: "Speechma", descricao: "Plataforma de IA para converter texto em voz e transcrever áudio em texto com suporte a 50+ idiomas.", url: "/ferramentas/speechma" },
    { nome: "Speechify", descricao: "Plataforma de IA para transcrição e conversão de texto em áudio com vozes naturais.", url: "/ferramentas/speechify" },
    { nome: "Otter AI", descricao: "Transcrição de reuniões em tempo real com identificação de falantes e resumos automáticos.", url: "/ferramentas/otter-ai" },
];
