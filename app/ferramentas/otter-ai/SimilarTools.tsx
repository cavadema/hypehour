...
const similarTools = [
    { nome: "Tactiq", descricao: "Gerador de atas com IA para Zoom, Meet e Teams diretamente no navegador.", url: "/ferramentas/tactiq" },
    { nome: "Granola AI", descricao: "Bloco de notas com IA para reuniões que combina suas anotações com a transcrição automática.", url: "/ferramentas/granola-ai" },
    { nome: "Speechma", descricao: "Plataforma de IA para converter texto em voz realista e transcrever áudio em texto.", url: "/ferramentas/speechma" },
];
