...
const similarTools = [
    { nome: "ClipDrop", descricao: "Suite de IA para remover fundos, upscaling e edição inteligente de imagens.", url: "/ferramentas/clipdrop" },
    { nome: "Ideogram", descricao: "Gerador de imagens com IA que se destaca na renderização precisa de texto.", url: "/ferramentas/ideogram" },
    { nome: "Midjourney", descricao: "Geração de imagens artísticas de altíssima qualidade com IA.", url: "/ferramentas/midjourney" },
];
