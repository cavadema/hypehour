...
export default function ExcelmaticPage() {
  const schemaData = {
    ...
    "@graph": [
      ...
      {
        "@type": "WebPage",
        "@id": "https://www.hypehour.com.br/ferramentas/excelmatic#webpage",
        "url": "https://www.hypehour.com.br/ferramentas/excelmatic",
        "name": "Excelmatic AI - Gerador de Fórmulas e Automação",
        "description": "Conheça o Excelmatic AI: a ferramenta de inteligência artificial que cria fórmulas de Excel, scripts VBA e analisa dados via chat. Veja como funciona e preços.",
        "isPartOf": { "@id": "https://www.hypehour.com.br/#website" },
        "breadcrumb": { "@id": "https://www.hypehour.com.br/ferramentas/excelmatic#breadcrumb" },
        "datePublished": "2025-11-19",
        "dateModified": "2026-07-04",
        "inLanguage": "pt-BR",
        "mainEntity": { "@id": "https://www.hypehour.com.br/ferramentas/excelmatic#software" },
      },
      ...
      },
      {
        ...
        "mainEntityOfPage": { "@id": "https://www.hypehour.com.br/ferramentas/excelmatic#webpage" },
                ...
                <section className="mb-12">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        {[
                            ...
                            "Poupe tempo em tarefas manuais"].map((item, index) => (
                ...
                <section className="mb-12">
                    ...
                    <div className="grid gap-4">
                        {[
                            ...
                            "Planos flexíveis que atendem desde usuários solo a grandes empresas"].map((advantage, index) => (
                ...
                <section className="mb-12">
                    ...
                    <div className="grid gap-4">
                        {[
                            ...
                            "Requer uma conta conectada à internet para funcionar (ferramenta baseada em nuvem)"].map((disadvantage, index) => (
