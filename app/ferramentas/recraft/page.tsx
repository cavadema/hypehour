...
export default function RecraftPage() {
  const schemaData = {
    "@context": "https://schema.org", "@graph": [
      ...
      {
        "@type": "WebPage",
        "@id": "https://www.hypehour.com.br/ferramentas/recraft#webpage",
        "url": "https://www.hypehour.com.br/ferramentas/recraft",
        "name": "Recraft - Gerador de Imagens e Vetores SVG com IA para Designers",
        "description": "Conheça o Recraft: plataforma de IA para criar imagens fotorrealistas, vetores SVG editáveis e assets de design com estilos personalizados. Veja vantagens, desvantagens e se é ideal para você.",
        "isPartOf": { "@id": "https://www.hypehour.com.br/#website" },
        "breadcrumb": { "@id": "https://www.hypehour.com.br/ferramentas/recraft#breadcrumb" },
        "datePublished": "2025-11-19",
        "dateModified": "2026-07-04",
        "inLanguage": "pt-BR",
        "mainEntity": { "@id": "https://www.hypehour.com.br/ferramentas/recraft#software" },
      },
    ...
    <main className="min-h-screen bg-[#f7f8fa]">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <section className="bg-black rounded-xl p-10 text-white text-center mb-12 shadow-lg">
          ...
          <a href="https://www.recraft.ai" target="_blank" rel="noopener noreferrer nofollow" className="inline-block px-8 py-4 bg-white text-black font-bold rounded-lg hover:shadow-xl transition">Acessar Recraft →</a>
        </section>
