...
const similarTools = [
    ...
    {
        nome: "Browserless",
        descricao: "Automação de navegadores headless em escala para Puppeteer e Playwright.",
        url: "/ferramentas/browserless"
    },
    {
        nome: "ScraperAPI",
        descricao: "API que gerencia proxies e captchas para extração de dados sem bloqueios.",
