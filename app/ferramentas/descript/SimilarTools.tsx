...
const similarTools = [
    { nome: "Clipchamp", descricao: "Editor de vídeo online com IA para criar e editar conteúdo para redes sociais.", url: "/ferramentas/clipchamp" },
    { nome: "Opusclip", descricao: "IA que recorta os melhores momentos de vídeos longos para redes sociais.", url: "/ferramentas/opusclip" },
