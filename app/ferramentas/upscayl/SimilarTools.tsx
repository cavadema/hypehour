...
const similarTools = [
    ...
    { nome: "insMind", descricao: "Editor de fotos com IA para remover fundos e criar imagens profissionais de produtos.", url: "/ferramentas/insmind" },
    { nome: "Krea", descricao: "Plataforma criativa de IA para geração e edição de imagens em tempo real.", url: "/ferramentas/krea" },
];
