...
const similarTools = [
    {
        nome: "Browse AI",
        descricao: "Monitore e extraia dados de qualquer site sem código usando robôs inteligentes.",
        url: "/ferramentas/browse-ai"
    },
    {
        nome: "Crawl4AI",
        descricao: "Crawler e scraper open-source amigável para LLMs e otimizado para RAG.",
        url: "/ferramentas/crawl4ai"
    },
    {
        nome: "Browserless",
        descricao: "Automação de navegadores headless em nuvem para Puppeteer e Playwright.",
