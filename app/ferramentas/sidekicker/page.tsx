...
export default function SidekickerPage() {
  const schemaData = {
    ...
    "@graph": [
      ...
      {
        "@type": "WebPage",
        "@id": "https://www.hypehour.com.br/ferramentas/sidekicker#webpage",
        "url": "https://www.hypehour.com.br/ferramentas/sidekicker",
        "name": "Sidekicker AI - Detector de IA e Humanizador",
        "description": "Descubra o Sidekicker AI: o detector de IA que também humaniza textos e verifica plágio. Veja como funciona, preços e se vale a pena.",
        "isPartOf": { "@id": "https://www.hypehour.com.br/#website" },
        "breadcrumb": { "@id": "https://www.hypehour.com.br/ferramentas/sidekicker#breadcrumb" },
        "datePublished": "2025-11-19",
        "dateModified": "2026-07-04",
        "inLanguage": "pt-BR",
        "mainEntity": { "@id": "https://www.hypehour.com.br/ferramentas/sidekicker#software" },
      },
      ...
      },
      {
        ...
        "mainEntityOfPage": { "@id": "https://www.hypehour.com.br/ferramentas/sidekicker#webpage" },
        "image": "https://www.hypehour.com.br/logo.png",
        "featureList": ["Insira seu conteúdo","Análise Tripla","Humanização Assistida","Exportação e Validação","Detector de IA Multi-Modelo","AI Humanizer Integrado"],
                ...
                <section className="mb-12">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        {[
                            ...
                            "Melhorar clareza de relatórios"].map((item, index) => (
                ...
                <section className="mb-12">
                    ...
                    <div className="grid gap-4">
                        {[
                            ...
                            "Funciona bem para o português e outros idiomas globais"].map((advantage, index) => (
                ...
                <section className="mb-12">
                    ...
                    <div className="grid gap-4">
                        {[
                            ...
                            "Assinatura automática após o período de teste requer atenção extra"].map((disadvantage, index) => (
