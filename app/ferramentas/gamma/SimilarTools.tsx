...
const similarTools = [
    { nome: "Slidesgo", descricao: "Templates profissionais para Google Slides e PowerPoint com suporte a IA.", url: "/ferramentas/slidesgo" },
    { nome: "Smallppt", descricao: "Gerador de apresentações com IA que cria slides completos a partir de texto.", url: "/ferramentas/smallppt" },
    { nome: "Visme", descricao: "Plataforma de design visual com IA para criar apresentações, infográficos e vídeos.", url: "/ferramentas/visme" },
];
