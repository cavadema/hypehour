...
const similarTools = [
    ...
    { nome: "Viggle AI", descricao: "Anime qualquer personagem com movimentos realistas usando vídeos de referência.", url: "/ferramentas/viggle-ai" },
    { nome: "Pixverse", descricao: "Gerador de vídeos com IA em múltiplos estilos a partir de texto ou imagem.", url: "/ferramentas/pixverse" },
];
