...
const similarTools = [
    { nome: "RoomX AI", descricao: "Transforme fotos de ambientes em designs de interiores com dezenas de estilos.", url: "/ferramentas/roomxai" },
    { nome: "Dzine", descricao: "Geração e edição de imagens com IA, face swap e generative fill.", url: "/ferramentas/dzine" },
