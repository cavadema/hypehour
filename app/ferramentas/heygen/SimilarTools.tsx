...
const similarTools = [
    ...
    {
        nome: "Hailuo AI",
        descricao: "Plataforma inovadora que transforma prompts em vídeos cinematográficos de alta qualidade.",
        url: "/ferramentas/hailuo-ai"
    },
    {
        nome: "Krea",
        descricao: "Geração de imagens em tempo real e aprimoramento profissional com AI Enhancer.",
