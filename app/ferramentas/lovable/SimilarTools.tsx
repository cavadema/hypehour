...
const similarTools = [
    ...
    { nome: "Bolt.new", descricao: "Desenvolvimento full-stack com IA no navegador com deploy no Netlify.", url: "/ferramentas/bolt-new" },
    { nome: "Base44", descricao: "Crie aplicações web completas com backend e banco de dados usando IA.", url: "/ferramentas/base44" },
];
