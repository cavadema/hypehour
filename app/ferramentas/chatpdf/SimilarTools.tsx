...
const similarTools = [
    { nome: "Lightpdf", descricao: "Suite completa de ferramentas com IA para editar, converter e analisar PDFs.", url: "/ferramentas/lightpdf" },
    { nome: "SciSpace", descricao: "Pesquise, leia e entenda artigos científicos com IA em 200M+ papers.", url: "/ferramentas/scispace" },
