...
export default function GobiiPage() {
  const schemaData = {
    "@context": "https://schema.org", "@graph": [
      ...
      {
        "@type": "WebPage",
        "@id": "https://www.hypehour.com.br/ferramentas/gobii#webpage",
        "url": "https://www.hypehour.com.br/ferramentas/gobii",
        "name": "Gobii AI - Criação de Agentes de IA sem Código",
        "description": "Conheça o Gobii AI: plataforma no-code para criar agentes de IA personalizados que automatizam tarefas, respondem perguntas e integram com seus sistemas. Veja vantagens, desvantagens e se é ideal para você.",
        "isPartOf": { "@id": "https://www.hypehour.com.br/#website" },
        "breadcrumb": { "@id": "https://www.hypehour.com.br/ferramentas/gobii#breadcrumb" },
        "datePublished": "2025-11-19",
        "dateModified": "2026-07-04",
        "inLanguage": "pt-BR",
        "mainEntity": { "@id": "https://www.hypehour.com.br/ferramentas/gobii#software" },
      },
    ...
    <main className="min-h-screen bg-[#f7f8fa]">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <section className="bg-black rounded-xl p-10 text-white text-center mb-12 shadow-lg">
          ...
          <a href="https://gobii.ai" target="_blank" rel="noopener noreferrer nofollow" className="inline-block px-8 py-4 bg-white text-black font-bold rounded-lg hover:shadow-xl transition">Acessar Gobii AI →</a>
        </section>
