...
export default function TonkotsuPage() {
  const schemaData = {
    "@context": "https://schema.org", "@graph": [
      ...
      { "@type": "SoftwareApplication", "@id": "https://www.hypehour.com.br/ferramentas/tonkotsu#software", name: "Tonkotsu AI", description: "Plataforma visual para criação de fluxos de agentes de IA com suporte a ferramentas, memória persistente e execução autônoma de tarefas.", applicationCategory: "DeveloperApplication", operatingSystem: "Web", url: "https://tonkotsu.ai", mainEntityOfPage: "https://www.hypehour.com.br/ferramentas/tonkotsu", creator: { "@type": "Organization", name: "Tonkotsu AI" } },
    ],
  };
    ...
    <main className="min-h-screen bg-[#f7f8fa]">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <section className="bg-black rounded-xl p-10 text-white text-center mb-12 shadow-lg">
          ...
          <a href="https://tonkotsu.ai" target="_blank" rel="noopener noreferrer" className="inline-block px-8 py-4 bg-white text-black font-bold rounded-lg hover:shadow-xl transition">Acessar Tonkotsu AI →</a>
        </section>
