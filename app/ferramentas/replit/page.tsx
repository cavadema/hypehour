  ...
  const schemaData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "mainEntityOfPage": "https://www.hypehour.com.br/ferramentas/replit",
    ...
    <main className="min-h-screen bg-[#f7f8fa]">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <section className="bg-black rounded-xl p-10 text-white text-center mb-12 shadow-lg">
          ...
          <a href="https://replit.com/" target="_blank" rel="noopener noreferrer" className="inline-block px-8 py-4 bg-white text-black font-bold rounded-lg hover:shadow-xl transition">Acessar Replit →</a>
        </section>
