...
const similarTools = [
    { nome: "Excelmatic", descricao: "Ferramenta de IA para automatizar tarefas e análises em planilhas do Excel.", url: "/ferramentas/excelmatic" },
    { nome: "Julius AI", descricao: "Analise dados e extraia insights conversando com planilhas e arquivos.", url: "/ferramentas/julius-ai" },
    { nome: "Claude for Excel", descricao: "Assistente de IA integrado ao Excel para análise e automação de planilhas.", url: "/ferramentas/claude-for-excel" },
];
