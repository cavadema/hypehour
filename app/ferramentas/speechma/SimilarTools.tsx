...
const similarTools = [
    {
        nome: "Speechify",
        descricao: "Plataforma de IA para transcrição e conversão de texto em áudio com vozes naturais.",
        url: "/ferramentas/speechify"
    },
    {
        nome: "Wisprflow",
        descricao: "Transcrição automática de áudio com IA para fluxos de trabalho profissionais.",
        url: "/ferramentas/wisprflow"
    },
    {
        nome: "Willow",
        descricao: "Ferramenta de transcrição de voz com IA para criar textos precisos a partir de áudio.",
        url: "/ferramentas/willow"
    }
];
