...
const ferramentas = [
  ...
  { nome: "Macaron", url: "/ferramentas/macaron", descricao: "Assistente de IA pessoal com interface elegante e acesso a modelos de linguagem avançados para produtividade diária." },
  {
    nome: "Grain",
    url: "https://grain.com/",
    descricao: "Gravador e assistente de reuniões com IA que gera transcrições e insights automáticos.",
  },
  {
    nome: "Blockit",
  ...
  { nome: "Glady", url: "https://www.gladly.com/", descricao: "Transforma o atendimento ao cliente em suporte inteligente, automatizado e personalizado em todos os canais." },
  ...
  return (
    <main className="max-w-6xl mx-auto py-10 px-4">
      <nav className="flex items-center gap-2 text-sm text-zinc-500 mb-6" aria-label="Breadcrumb">
        ...
        <span>/</span>
        <span className="text-black font-medium">Assistentes de IA e pessoais</span>
      </nav>
      ...
      <CategoryPageSchema
        title="Assistentes de IA e pessoais"
        description="Ferramentas para criar e usar assistentes de IA pessoais e profissionais."
        canonicalUrl="https://www.hypehour.com.br/assistentes-de-ia"
