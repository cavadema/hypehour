...
export const metadata = {
  ...
  openGraph: {
    title: "Inteligência Artificial para vendas",
    description: "Descubra as melhores ferramentas de IA para vendas: prospecção, qualificação de leads, outreach e automação de vendas.",
    url: "https://www.hypehour.com.br/ia-para-vendas",
    siteName: 'Hypehour',
  ...
  return (
    <main className="max-w-6xl mx-auto py-10 px-4">
      <nav className="flex items-center gap-2 text-sm text-zinc-500 mb-6" aria-label="Breadcrumb">
        ...
        <span>/</span>
        <span className="text-black font-medium">IA para Vendas</span>
      </nav>
      ...
      <CategoryPageSchema
        title="Inteligência Artificial para vendas"
        description="Descubra as melhores ferramentas de IA para vendas: prospecção, qualificação de leads, outreach e automação de vendas."
        canonicalUrl="https://www.hypehour.com.br/ia-para-vendas"
