  ...
  return (
    <main className="max-w-6xl mx-auto py-10 px-4">
      <nav className="flex items-center gap-2 text-sm text-zinc-500 mb-6" aria-label="Breadcrumb">
        ...
        <span>/</span>
        <span className="text-black font-medium">IA para Conteúdo</span>
      </nav>
      <div className="flex items-center gap-3 mb-8">
        <PencilSquareIcon className="w-10 h-10 text-gray-900" />
      ...
      <CategoryPageSchema
        title="Ferramentas de IA para Conteúdo"
        description="Descubra as melhores ferramentas de IA para criar artigos, posts, e-mails e copys de alta conversão."
        canonicalUrl="https://www.hypehour.com.br/ferramentas-de-ia-para-conteudo"
