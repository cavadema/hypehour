...
const cursos = [
  { nome: "AI Training Checklist", url: "https://about.you.com/ai-training-checklist", descricao: "Guia completo da You.com para treinamento e adoção de IA em fluxos profissionais." },
  ...
  return (
    <main className="max-w-6xl mx-auto py-10 px-4">
      <nav className="flex items-center gap-2 text-sm text-zinc-500 mb-6" aria-label="Breadcrumb">
        ...
        <span>/</span>
        <span className="text-black font-medium">Cursos de IAs</span>
      </nav>
