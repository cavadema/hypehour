...
const ferramentas = [
  ...
  { nome: "Riverside", url: "https://riverside.fm/", descricao: "Plataforma de gravação e transcrição com IA para podcasts e vídeos profissionais." },
  ...
  return (
    <main className="max-w-6xl mx-auto py-10 px-4">
      <nav className="flex items-center gap-2 text-sm text-zinc-500 mb-6" aria-label="Breadcrumb">
        ...
        <span>/</span>
        <span className="text-black font-medium">Transcrever áudio</span>
      </nav>
      ...
      <CategoryPageSchema
        title="Inteligência Artificial para Transcrever áudio"
        description="As melhores ferramentas de IA para transcrever áudio em texto com precisão e rapidez."
        canonicalUrl="https://www.hypehour.com.br/transcrever-audio"
