...
const ferramentas = [
  ...
  { nome: "VidNoz", url: "https://pt.vidnoz.com/gerador-de-voz-ia.html", descricao: "Gerador de voz IA com vozes variadas em português." },
  { nome: "Speaktor", url: "https://speaktor.com/", descricao: "Conversão de texto para fala com múltiplos idiomas." },
  { nome: "Invideo", url: "https://invideo.io/pt/tools/gerador-de-voz-ia/", descricao: "Vozes IA integradas ao fluxo de criação de vídeos." },
  { nome: "Speechify", url: "https://speechify.com/pt-br/ai-voice-generator", descricao: "Gerador de voz IA popular com vozes naturais." },
  { nome: "Freepik", url: "https://br.freepik.com/ai/gerador-voz", descricao: "Ferramenta IA para voz dentro do ecossistema Freepik." },
  { nome: "ClipChamp", url: "https://clipchamp.com/pt-br/features/ai-voice-over-generator/", descricao: "Gerador de voz integrado ao editor de vídeos ClipChamp." },
  ...
  { nome: "Kapwing", url: "https://www.kapwing.com/pt-br/ai/voice-generator", descricao: "Gerador de voz IA integrado ao editor Kapwing." },
  ...
  { nome: "Luvvoice", url: "https://luvvoice.com/br/language/portuguese", descricao: "Vozes IA específicas para português do Brasil." },
  { nome: "Synthesia", url: "https://www.synthesia.io/pt-br/features/gerador-voz-ia", descricao: "Vozes IA integradas à criação de vídeos com avatares." },
  { nome: "FlexClip", url: "https://www.flexclip.com/pt/tools/ai-voice-generator/", descricao: "Ferramenta de voz IA no editor FlexClip." },
